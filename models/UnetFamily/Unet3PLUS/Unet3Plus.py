...
from models.UnetFamily.BLOCK.layers import unetConv2
from models.UnetFamily.BLOCK.init_weights import init_weights
...
class UNet_3Plus_DeepSup(nn.Module):
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True,other=True):
...
class UNet_3Plus_DeepSup_CGM(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True,other=False):
...
#     net= UNet_3Plus_DeepSup_CGM(in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True).cuda()
#     out = net(x)
#     summary(net, (3, 128, 128))
#     print(net)
#     # for i in range(psi1.shape[0]):
#     #     print(psi1[i][0].detach().cpu().unsqueeze(dim=0).shape)
#     print('输出：',out[1].shape)
#
