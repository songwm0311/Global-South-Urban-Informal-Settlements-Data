...
o	Vulnerability: composite UISVI value. 
...
1.	generation of urban informal-settlement predictions; 
2.	estimation of city-level settlement extent and volume; 
3.	Monte Carlo Dropout-based uncertainty quantification; 
4.	construction of VIS1, VIS2, VIS3, and UISVI indicators; 
5.	regional comparison of informal-settlement vulnerability patterns. 
